...
def add_subparser(parser):
   ...
   subparser.add_argument('-l', type=str, help='Location ids. Either a comma-separated list of ids (e.g. 18700,50540), a filename with list of stations (new-line, comma-, and/or space-separated), or unspecified (all stations downloaded).', dest="locations")
